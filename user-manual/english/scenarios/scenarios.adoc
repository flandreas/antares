...
Scenario texts are displayed during simulation if the simulation speed category is "Observe" or slower. This is a fix system setting. You can disable scenario texts using menu menu:Simulation[Show scenario texts].