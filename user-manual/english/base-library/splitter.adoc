...
In the current version of Antares, the splitter does not support bidirectional pins. Therefore, for combining wires into wire bundles, the link:{{site.basedir}}/user-manual/english/base-library/combiner[combiner component] must be used.
