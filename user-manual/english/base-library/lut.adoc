...
The lookup table consists of an internal read-only memory whose data cell bit with is determined by the attribute "Data Bit Width". The size of the memory (i.e. the number of cells) is determined by the attribute "Address Bit Width".
...
A:: Address Input. Its bit width is determined by attribute "Address Bit Width".

D:: Data Output. Its bit width is determined by attribute "Data Bit Width".
