...
Value (decimal):: The value (in decimal notation) that is produced at the output of the constant. It can also be an expression that uses circuit parameters to calculate the value.