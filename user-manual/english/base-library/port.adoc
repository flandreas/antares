...
Start value:: The decimal value to be asserted when the simulation is started. Only used if the port is unconnected. If empty, the value is taken from the default value, which is 0.
