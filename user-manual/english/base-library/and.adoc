...
Data Input:: In this attribute the number of the input containing the data path can be selected if the feature "data path" (see above) is to be used. In the direction of data flow through the AND gate, number 1 designates the left-most input.