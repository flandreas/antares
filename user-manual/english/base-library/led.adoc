...
LED shape:: Determines whether the LED is drawn as a circle, a square, or a narrow stripe. This can be useful when the LED is added as control to the circuit's symbol.
