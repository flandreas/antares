...
Switch mode using zoom factor:: If set, you can switch between the circuit editor and the symbol editor by zooming out and zooming in with large factors.

Docking (experimental):: If set, you can pick a desktop view (circuit or subcircuit) on its header bar and drag it to another location within the desktop.
