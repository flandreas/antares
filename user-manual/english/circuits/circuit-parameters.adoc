...
* **Description**: A multi-language description that will be displayed in the properties window when editing a subcircuit property defined by this parameter definition.
