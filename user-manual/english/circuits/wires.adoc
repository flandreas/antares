...
To start creating a new wire, move the mouse over a pin of a component or an existing wire. Antares will then show a small orange circle to indicate that you can start a new wire at this point.
