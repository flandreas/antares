...
If you are using Antares for the first time, you will find an easy to understand introduction to Antares in the chapter link:{{site.basedir}}/user-manual/english/first-steps/first-steps["First Steps"]. The other chapters in the "Basics" section cover important topics such as using projects and libraries.
